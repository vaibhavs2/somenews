...
import {UI_COLOR_DARK} from '../UIConstants.js';
...
const Attribute = ({text}) => <Text style={styles.attribute}>{text}:</Text>;

export default function BriefNewsBriefPopUP(props: Props): Node {
  ...
  return (
    <SafeAreaView>
      <Modal
        ...
        onRequestClose={setModalInVisible}
        onBackdropPress={() => {
          setModalInVisible();
        }}>
